...
import { ScrollView, View, Image, Text, FlatList, SafeAreaView } from 'react-native'
...
const UserComponent:React.FunctionComponent<PrivateRouteProps>= ({
          ...
          <FlatList
              ...
              <Card style={styles.card}>
                ...
                <Card.Content>
                  ...
                  <Text onPress={() => navigate('Follower')}>followers: {item.node.followers.totalCount}</Text>
                  <Text onPress={() => navigate('Following')}>following: {item.node.following.totalCount}</Text>
                  <Text onPress={() => navigate('Repo', {username: item.node.login})}>Total Repos: {item.node.repositories.totalCount}</Text>
                </Card.Content>
              </Card>)
